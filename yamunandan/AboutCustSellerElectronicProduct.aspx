<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AboutCustSellerElectronicProduct.aspx.cs" Inherits="yamunandan.AboutElectronicProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center"><h1> About Customer Seller Electronic Product's</h1></div>
    <asp:Label ID="Electronic" runat="server" Text="Electronic Product" Visible="False"></asp:Label>
    <br />
